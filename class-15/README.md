...
- There are different types of authentication. Give an example of being authenticated using OAuth.
...
- What is Auth0? What are the requirements to use Auth0?
...
- How does Auth0 make sure you are who you say you are?
